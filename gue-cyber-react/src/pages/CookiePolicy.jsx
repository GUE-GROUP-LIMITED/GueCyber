      ...
      <Box sx={{ position: "relative", py: { xs: 12, md: 17 }, overflow: "hidden", background: "#ffffff" }}>
        ...
        <Container maxWidth="lg" sx={{ position: "relative", zIndex: 1, textAlign: "center" }}>
          ...
          <Typography sx={{ color: "#475569", maxWidth: 760, mx: "auto", fontSize: { xs: "1rem", md: "1.12rem" }, lineHeight: 1.65 }}>
            GUE Cyber website currently does not use cookies for analytics, advertising, or user tracking.
          </Typography>
        </Container>
      </Box>
        ...
        <Container maxWidth="lg">
          <Box sx={{ bgcolor: "#a3e635", borderRadius: { xs: 4, md: 5 }, px: { xs: 2.5, md: 6 }, py: { xs: 4, md: 5 } }}>
            ...
            <Typography sx={{ color: "#10403d", lineHeight: 1.75 }}>
              We do not set cookies for behavioral analytics, remarketing, or ad personalization. Your session on this
              website is not profiled through cookie tracking.
            </Typography>
          </Box>
        </Container>
      </Box>
